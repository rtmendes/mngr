...
from imbue.mngr_mind.data_types import ConversationId
from imbue.mngr_mind.data_types import MessageEvent
from imbue.mngr_mind.data_types import MessageRole
from imbue.mngr_mind.data_types import MindEvent
from imbue.mngr_mind.data_types import SOURCE_MESSAGES
...
def test_mind_event_with_data() -> None:
    event = MindEvent(
        ...
        event_id=_EID,
        source=EventSource("mngr/agents"),
