...
def test_empty_history_produces_no_output(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_single_session_emits_all_lines(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_multiple_sessions_emit_all(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_offset_tracking_skips_already_emitted(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_reconciliation_after_crash(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_missing_session_file_no_crash(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_empty_session_file(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_no_duplicate_emission(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_incremental_emission(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_multiple_sessions_concurrent_writes(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_reconciliation_with_empty_output(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_offset_clamped_to_file_size(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_offset_directory_created(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_offset_stored_in_plugin_claude_directory(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_session_added_after_initial_load(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_history_with_extra_fields(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_duplicate_session_id_in_history(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_various_file_sizes(tmp_path: Path, stub_mng_log_sh: str, line_count: int) -> None:
...
def test_reconciliation_finds_highest_emitted_line(tmp_path: Path, stub_mng_log_sh: str) -> None:
...
def test_multiple_sessions_partial_reconciliation(tmp_path: Path, stub_mng_log_sh: str) -> None:
