#!/usr/bin/env python3
"""Conversation watcher for mind agents.
...
Tracked conversations are read from the mind_conversations table
in the llm database (created during provisioning).

Usage: mngr mind-conversation-watcher
...
def _get_tracked_conversation_ids(db_path: Path) -> set[str]:
    """Read tracked conversation IDs from the mind_conversations table in the llm database."""
