"""Context gathering tool for mind conversations.

This file is passed to `llm live-chat` via `--functions` and provides
the conversation agent with context about the current state of the mind.
...
def gather_context() -> str:
    ...
    - New trigger events (from events/scheduled/, mngr/agents/, stop/, monitor/)
    ...
    for source in ("scheduled", "mngr/agents", "stop", "monitor"):
