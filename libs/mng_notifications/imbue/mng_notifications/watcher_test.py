...
from imbue.mng_notifications.watcher import _get_file_size
from imbue.mng_notifications.watcher import _process_events
from imbue.mng_notifications.watcher import _read_from_offset
...
def test_process_events_non_state_change_ignored(notification_cg: ConcurrencyGroup) -> None:
    notifier = RecordingNotifier()
    content = json.dumps(
        {"type": "AGENT_STATE", "timestamp": "2026-01-01T00:00:00Z", "event_id": "evt-x", "source": "mng/agents"}
    )
