...
from imbue.mngr.cli.list import _stream_emit_line
from imbue.mngr.cli.list import _stream_tail_events_file
...
def test_stream_tail_detects_new_content(temp_config: MngrConfig) -> None:
