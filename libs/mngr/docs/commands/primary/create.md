...
| `--project` | text | Project name for the agent (sets the 'project' label; '.' is equivalent to omitting this flag) [default: derived from git remote origin or folder name] | None |
