...
If plugins restrict themselves to accessing just data via read_file for files within the `MNG_HOST_DIR`, then the offline_mng_state plugin [future] will allow offline access to that data.
