...
Modal sandboxes are isolated environments that don't have direct access to Modal's control plane APIs. To allow agents running inside Modal sandboxes to pause or stop themselves, mng must deploy a Modal function that agents can call.
