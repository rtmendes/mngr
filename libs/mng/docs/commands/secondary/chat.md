...
- [mng connect](../primary/connect.md) - Connect to an agent's tmux session
- [mng message](./message.md) - Send a message to an agent
- [mng exec](../primary/exec.md) - Execute a command on an agent's host
...
```bash
$ mng chat my-agent --new --name "Bug triage"
```

**Resume the most recent conversation**

```bash
$ mng chat my-agent --last
```

**Resume a specific conversation**

```bash
$ mng chat my-agent --conversation conv-1234567890-abcdef
```
