...
Thus two sets of credentials are required: one with read/write access for mng to be able to access the state, and one with write-only access for injecting into untrusted hosts.
