...
from imbue.minds.deployment.local import AgentIdLookupError
from imbue.minds.deployment.local import MngCreateError
from imbue.minds.deployment.local import _create_mng_agent
from imbue.minds.deployment.local import _generate_auth_code
from imbue.minds.deployment.local import _run_mng_command
...
from imbue.minds.deployment.local import update_local
from imbue.minds.errors import AgentAlreadyExistsError
from imbue.minds.errors import GitCloneError
from imbue.minds.errors import MngCommandError
from imbue.minds.primitives import AgentName
from imbue.minds.primitives import GitUrl
from imbue.minds.testing import FakeConcurrencyGroup
from imbue.minds.testing import init_and_commit_git_repo
from imbue.minds.testing import make_fake_concurrency_group
from imbue.minds.testing import make_finished_process
...
def test_agent_already_exists_error_message() -> None:
    err = AgentAlreadyExistsError(
        "An agent named 'my-agent' already exists. Use 'mind update' to update it, or 'mind destroy' to remove it."
    )
    assert "mind update" in str(err)
    assert "mind destroy" in str(err)
...
def test_create_mng_agent_always_includes_mind_label(tmp_path: Path) -> None:
    """Verify that all providers include --label mind=true."""
    for provider in DeploymentProvider:
        ...
        assert cmd[label_index + 1] == "mind=true"
