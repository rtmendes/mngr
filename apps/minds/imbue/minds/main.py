...
from imbue.minds.cli.deploy import deploy
from imbue.minds.cli.forward import forward
from imbue.minds.cli.list import list_command
...
def cli(ctx: click.Context, verbose: int, quiet: bool) -> None:
    """minds: deploy and manage your own persistent, specialized AI agents."""
